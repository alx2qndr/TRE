...
namespace tre {
Context::Context(const std::string& applicationNameRef, Window& windowRef)
    : applicationName(applicationNameRef)
    , window(windowRef)
{
    createInstance();
    setupDebugMessenger();
...
void Context::createInstance()
{
    ...
    appInfo.pApplicationName = "Tiny Rendering Application";
    appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
    appInfo.pEngineName = "Tiny Rendering Engine";
...
std::vector<const char*> Context::getRequiredExtensions()
{
    ...
    std::vector<const char*> extensions(extensionsNames, extensionsNames + extensionCount);
